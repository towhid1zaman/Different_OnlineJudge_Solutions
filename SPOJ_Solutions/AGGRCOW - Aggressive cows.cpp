...
//we want to know if we can get atleast minDis distance with c cow
...
int main(){
        ...
        while(T--){
            ...
            sort(pos,pos+n);
            int l = 0;
            int h = pos[n-1]-pos[0]+1;// If we can do with minDis distance then oviously  we can do it with <=minDis.
